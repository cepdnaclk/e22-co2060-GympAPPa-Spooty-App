...
import { getRoleDisplayName, DEFAULT_PROFILE_PICTURE } from '../utils/helpers';
          ...
          <div className="profile-picture-section">
            {editMode ? (
              <div id="image-input-wrapper" className="profile-upload">
                <img src={formData.profilePicture || DEFAULT_PROFILE_PICTURE} alt="Profile" className="profile-image" />
                <label htmlFor="picture-input" className="upload-label">📷 Change</label>
                <input type="file" id="picture-input" onChange={handleProfilePictureChange} accept="image/*" style={{ display: 'none' }} />
                <button type="button" onClick={handleDeleteProfilePicture} className="delete-picture-btn">🗑️ Delete</button>
              </div>
            ) : (
              <img src={profile.profilePicture || DEFAULT_PROFILE_PICTURE} alt="Profile" className="profile-image" />
            )}
          </div>
              ...
              <form onSubmit={handleSubmit} className="profile-form">
                <div className="form-section">
                  ...
                  <div className="form-group">
                    ...
                    <input type="tel" id="tel" name="tel" value={formData.tel} onChange={handleChange} placeholder="e.g., +94XXXXXXXXX" />
                  </div>
                  <div className="form-group">
                    <label htmlFor="personalEmail">Personal Email (Optional)</label>
                    <input type="email" id="personalEmail" name="personalEmail" value={formData.personalEmail} onChange={handleChange} placeholder="e.g., yourname@gmail.com" />
                  </div>
                  <div className="form-group">
                    <label htmlFor="district">District (Optional)</label>
                    <input type="text" id="district" name="district" value={formData.district} onChange={handleChange} placeholder="e.g., Kandy" />
                  </div>
                </div>
                ...
                <form onSubmit={handlePasswordSubmit} className="password-form">
                  {!profile.needsPasswordSetup && (
                    <div className="form-group">
                      ...
                      <input type="password" id="currentPassword" name="currentPassword" value={passwordData.currentPassword} onChange={handlePasswordChange} placeholder="Enter current password to verify" />
                    </div>
                  )}
                  <div className="form-group">
                    <label htmlFor="password">New Password</label>
                    <input type="password" id="password" name="password" value={passwordData.password} onChange={handlePasswordChange} placeholder="Minimum 6 characters" required />
                  </div>
                  <div className="form-group">
                    <label htmlFor="confirmPassword">Confirm New Password</label>
                    <input type="password" id="confirmPassword" name="confirmPassword" value={passwordData.confirmPassword} onChange={handlePasswordChange} placeholder="Re-enter the new password" required />
                  </div>
            ...
            <div className="profile-view">
              ...
              <div className="profile-actions">
                ...
                {profile.role === 'student' && (
                  <button className="btn-secondary">Request Role Change</button>
                )}
              </div>
            </div>
          )}
